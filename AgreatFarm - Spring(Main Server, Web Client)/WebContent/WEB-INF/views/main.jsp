...
<html>
	<head>
	    ...
	    <script src="resources/js/farmList.js" type="text/javascript" charset="UTF-8"></script>
	    <script>
	    	var userNumber = <%=Integer.parseInt(m_num)%>;
	    	
	    	$(function(){
	    		makeFarmList(userNumber);
	    	});
	    	
			function moveToNodeServer(farmUrl){
				$(location).attr('href', farmUrl);
			}
	    </script>
	</head>
	<body>
